...
open class ListenersFactory(
    ...
    override fun ParameterSpecListScope.action(vararg params: TypeName): ParameterSpec =
        add("action", Unit::class.asTypeName().lambdaBy(*params), NOINLINE)
}
...
open class CoroutinesFactory(
    ...
    override fun ParameterSpecListScope.action(vararg params: TypeName): ParameterSpec = add(
        "action",
        Unit::class.asTypeName().lambdaBy(*params, receiver = CoroutineScope::class.asTypeName())
...
abstract class BaseListenersFactory(
    ...
    inline fun <reified Type> ParameterSpecListScope.action(): ParameterSpec =
        action(Type::class.asTypeName())
