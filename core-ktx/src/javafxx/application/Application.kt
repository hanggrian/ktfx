...
inline fun <reified A : Application> launch(vararg args: String) = launch(A::class.java, *args)

/** Launch JavaFX application and preloader with reified types. */
inline fun <reified A : Application, reified P : Preloader> launchWithPreloader(vararg args: String) =
