...
inline fun Node.addDecoration(decoration: Decoration): Unit = Decorator.addDecoration(this, decoration)

/** Removes the given decoration from the given node. */
inline fun Node.removeDecoration(decoration: Decoration): Unit = Decorator.removeDecoration(this, decoration)
