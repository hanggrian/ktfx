...
inline fun ChildManager.anchorPane(init: (@LayoutDsl _AnchorPane).() -> Unit): AnchorPane = kotfx.scene.anchorPane(init).add()
inline fun ItemManager.anchorPane(init: (@LayoutDsl _AnchorPane).() -> Unit): AnchorPane = kotfx.scene.anchorPane(init).add()
inline fun ButtonManager.anchorPane(init: (@LayoutDsl _AnchorPane).() -> Unit): AnchorPane = kotfx.scene.anchorPane(init).add()
...
inline fun ChildManager.borderPane(init: (@LayoutDsl _BorderPane).() -> Unit): BorderPane = kotfx.scene.borderPane(init).add()
inline fun ItemManager.borderPane(init: (@LayoutDsl _BorderPane).() -> Unit): BorderPane = kotfx.scene.borderPane(init).add()
inline fun ButtonManager.borderPane(init: (@LayoutDsl _BorderPane).() -> Unit): BorderPane = kotfx.scene.borderPane(init).add()
...
inline fun ChildManager.flowPane(init: (@LayoutDsl _FlowPane).() -> Unit): FlowPane = kotfx.scene.flowPane(init).add()
inline fun ItemManager.flowPane(init: (@LayoutDsl _FlowPane).() -> Unit): FlowPane = kotfx.scene.flowPane(init).add()
inline fun ButtonManager.flowPane(init: (@LayoutDsl _FlowPane).() -> Unit): FlowPane = kotfx.scene.flowPane(init).add()
...
inline fun ChildManager.gridPane(init: (@LayoutDsl _GridPane).() -> Unit): GridPane = kotfx.scene.gridPane(init).add()
inline fun ItemManager.gridPane(init: (@LayoutDsl _GridPane).() -> Unit): GridPane = kotfx.scene.gridPane(init).add()
inline fun ButtonManager.gridPane(init: (@LayoutDsl _GridPane).() -> Unit): GridPane = kotfx.scene.gridPane(init).add()
...
inline fun ChildManager.hbox(init: (@LayoutDsl _HBox).() -> Unit): HBox = kotfx.scene.hbox(init).add()
inline fun ItemManager.hbox(init: (@LayoutDsl _HBox).() -> Unit): HBox = kotfx.scene.hbox(init).add()
inline fun ButtonManager.hbox(init: (@LayoutDsl _HBox).() -> Unit): HBox = kotfx.scene.hbox(init).add()
...
inline fun ChildManager.stackPane(init: (@LayoutDsl _StackPane).() -> Unit): StackPane = kotfx.scene.stackPane(init).add()
inline fun ItemManager.stackPane(init: (@LayoutDsl _StackPane).() -> Unit): StackPane = kotfx.scene.stackPane(init).add()
inline fun ButtonManager.stackPane(init: (@LayoutDsl _StackPane).() -> Unit): StackPane = kotfx.scene.stackPane(init).add()
...
inline fun ChildManager.textFlow(init: (@LayoutDsl _TextFlow).() -> Unit): TextFlow = kotfx.scene.textFlow(init).add()
inline fun ItemManager.textFlow(init: (@LayoutDsl _TextFlow).() -> Unit): TextFlow = kotfx.scene.textFlow(init).add()
inline fun ButtonManager.textFlow(init: (@LayoutDsl _TextFlow).() -> Unit): TextFlow = kotfx.scene.textFlow(init).add()
...
inline fun ChildManager.tilePane(init: (@LayoutDsl _TilePane).() -> Unit): TilePane = kotfx.scene.tilePane(init).add()
inline fun ItemManager.tilePane(init: (@LayoutDsl _TilePane).() -> Unit): TilePane = kotfx.scene.tilePane(init).add()
inline fun ButtonManager.tilePane(init: (@LayoutDsl _TilePane).() -> Unit): TilePane = kotfx.scene.tilePane(init).add()
...
inline fun ChildManager.vbox(init: (@LayoutDsl _VBox).() -> Unit): VBox = kotfx.scene.vbox(init).add()
inline fun ItemManager.vbox(init: (@LayoutDsl _VBox).() -> Unit): VBox = kotfx.scene.vbox(init).add()
inline fun ButtonManager.vbox(init: (@LayoutDsl _VBox).() -> Unit): VBox = kotfx.scene.vbox(init).add()
