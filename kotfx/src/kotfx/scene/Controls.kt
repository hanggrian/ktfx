...
inline fun ButtonManager.accordion(vararg titledPanes: TitledPane, noinline init: ((@SceneDsl Accordion).() -> Unit)? = null): Accordion = Accordion(*titledPanes).apply { init?.invoke(this) }.add()

inline fun buttonBar(buttonOrder: String? = null, noinline init: ((@SceneDsl _ButtonBar).() -> Unit)? = null): ButtonBar = _ButtonBar(buttonOrder).apply { init?.invoke(this) }
inline fun ChildManager.buttonBar(buttonOrder: String? = null, noinline init: ((@SceneDsl _ButtonBar).() -> Unit)? = null): ButtonBar = _ButtonBar(buttonOrder).apply { init?.invoke(this) }.add()
inline fun ItemManager.buttonBar(buttonOrder: String? = null, noinline init: ((@SceneDsl _ButtonBar).() -> Unit)? = null): ButtonBar = _ButtonBar(buttonOrder).apply { init?.invoke(this) }.add()
inline fun ButtonManager.buttonBar(buttonOrder: String? = null, noinline init: ((@SceneDsl _ButtonBar).() -> Unit)? = null): ButtonBar = _ButtonBar(buttonOrder).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.button(text: String? = null, graphic: Node? = null, noinline init: ((@SceneDsl Button).() -> Unit)? = null): Button = Button(text, graphic).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.checkBox(text: String? = null, noinline init: ((@SceneDsl CheckBox).() -> Unit)? = null): CheckBox = CheckBox(text).apply { init?.invoke(this) }.add()
...
inline fun <T> ButtonManager.choiceBox(items: ObservableList<T> = mutableObservableListOf(), noinline init: ((@SceneDsl ChoiceBox<T>).() -> Unit)? = null): ChoiceBox<T> = ChoiceBox(items).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.colorPicker(color: Color = WHITE, noinline init: ((@SceneDsl ColorPicker).() -> Unit)? = null): ColorPicker = ColorPicker(color).apply { init?.invoke(this) }.add()
...
inline fun <T> ButtonManager.comboBox(items: ObservableList<T> = mutableObservableListOf(), noinline init: ((@SceneDsl ComboBox<T>).() -> Unit)? = null): ComboBox<T> = ComboBox(items).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.datePicker(date: LocalDate? = null, noinline init: ((@SceneDsl DatePicker).() -> Unit)? = null): DatePicker = DatePicker(date).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.hyperlink(text: String? = null, graphic: Node? = null, noinline init: ((@SceneDsl Hyperlink).() -> Unit)? = null): Hyperlink = Hyperlink(text, graphic).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.label(text: String? = null, graphic: Node? = null, noinline init: ((@SceneDsl Label).() -> Unit)? = null): Label = Label(text, graphic).apply { init?.invoke(this) }.add()
...
inline fun <T> ButtonManager.listView(items: ObservableList<T> = mutableObservableListOf(), noinline init: ((@SceneDsl ListView<T>).() -> Unit)? = null): ListView<T> = ListView(items).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.menuBar(vararg menus: Menu, noinline init: ((@SceneDsl _MenuBar).() -> Unit)? = null): MenuBar = _MenuBar(*menus).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.menuButton(text: String? = null, graphic: Node? = null, noinline init: ((@SceneDsl MenuButton).() -> Unit)? = null): MenuButton = MenuButton(text, graphic).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.pagination(count: Int = INDETERMINATE, index: Int = 0, noinline init: ((@SceneDsl Pagination).() -> Unit)? = null): Pagination = Pagination(count, index).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.passwordField(noinline init: ((@SceneDsl PasswordField).() -> Unit)? = null): PasswordField = PasswordField().apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.progressBar(progress: Double = INDETERMINATE_PROGRESS, noinline init: ((@SceneDsl ProgressBar).() -> Unit)? = null): ProgressBar = ProgressBar(progress).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.progressIndicator(progress: Double = INDETERMINATE_PROGRESS, noinline init: ((@SceneDsl ProgressIndicator).() -> Unit)? = null): ProgressIndicator = ProgressIndicator(progress).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.radioButton(text: String? = null, noinline init: ((@SceneDsl RadioButton).() -> Unit)? = null): RadioButton = RadioButton(text).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.scrollBar(noinline init: ((@SceneDsl ScrollBar).() -> Unit)? = null): ScrollBar = ScrollBar().apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.scrollPane(content: Node? = null, noinline init: ((@SceneDsl ScrollPane).() -> Unit)? = null): ScrollPane = ScrollPane(content).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.separator(orientation: Orientation = HORIZONTAL, noinline init: ((@SceneDsl Separator).() -> Unit)? = null): Separator = Separator(orientation).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.slider(min: Double, max: Double, value: Double, noinline init: ((@SceneDsl Slider).() -> Unit)? = null): Slider = Slider(min, max, value).apply { init?.invoke(this) }.add()
...
inline fun <T> ButtonManager.spinner(noinline init: ((@SceneDsl Spinner<T>).() -> Unit)? = null): Spinner<T> = Spinner<T>().apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.splitMenuButton(vararg items: MenuItem, noinline init: ((@SceneDsl SplitMenuButton).() -> Unit)? = null): SplitMenuButton = SplitMenuButton(*items).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.splitPane(vararg items: Node, noinline init: ((@SceneDsl SplitPane).() -> Unit)? = null): SplitPane = SplitPane(*items).apply { init?.invoke(this) }.add()
...
inline fun <S> ButtonManager.tableView(items: ObservableList<S> = mutableObservableListOf(), noinline init: ((@SceneDsl TableView<S>).() -> Unit)? = null): TableView<S> = TableView<S>(items).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.tabPane(vararg tabs: Tab, noinline init: ((@SceneDsl TabPane).() -> Unit)? = null): TabPane = TabPane(*tabs).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.tab(text: String? = null, content: Node? = null, noinline init: ((@SceneDsl Tab).() -> Unit)? = null): Tab = Tab(text, content).apply { init?.invoke(this) }
...
inline fun ButtonManager.textArea(text: String = "", noinline init: ((@SceneDsl TextArea).() -> Unit)? = null): TextArea = TextArea(text).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.textField(text: String = "", noinline init: ((@SceneDsl TextField).() -> Unit)? = null): TextField = TextField(text).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.titledPane(text: String? = null, content: Node? = null, noinline init: ((@SceneDsl TitledPane).() -> Unit)? = null): TitledPane = TitledPane(text, content).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.toggleButton(text: String? = null, graphic: Node? = null, noinline init: ((@SceneDsl ToggleButton).() -> Unit)? = null): ToggleButton = ToggleButton(text, graphic).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.toolBar(vararg items: Node, noinline init: ((@SceneDsl _ToolBar).() -> Unit)? = null): ToolBar = _ToolBar(*items).apply { init?.invoke(this) }.add()
...
inline fun <S> ButtonManager.treeTableView(root: TreeItem<S>? = null, noinline init: ((@SceneDsl TreeTableView<S>).() -> Unit)? = null): TreeTableView<S> = TreeTableView<S>(root).apply { init?.invoke(this) }.add()
...
inline fun <T> ButtonManager.treeView(root: TreeItem<T>? = null, noinline init: ((@SceneDsl TreeView<T>).() -> Unit)? = null): TreeView<T> = TreeView<T>(root).apply { init?.invoke(this) }.add()
//</editor-fold>
...
inline fun <X, Y> ButtonManager.areaChart(x: Axis<X>, y: Axis<Y>, data: ObservableList<Series<X, Y>> = mutableObservableListOf(), noinline init: ((@SceneDsl AreaChart<X, Y>).() -> Unit)? = null): AreaChart<X, Y> = AreaChart(x, y, data).apply { init?.invoke(this) }.add()
...
inline fun <X, Y> ButtonManager.barChart(x: Axis<X>, y: Axis<Y>, data: ObservableList<Series<X, Y>> = mutableObservableListOf(), gap: Double = 10.0, noinline init: ((@SceneDsl BarChart<X, Y>).() -> Unit)? = null): BarChart<X, Y> = BarChart(x, y, data, gap).apply { init?.invoke(this) }.add()
...
inline fun <X, Y> ButtonManager.bubbleChart(x: Axis<X>, y: Axis<Y>, data: ObservableList<Series<X, Y>> = mutableObservableListOf(), noinline init: ((@SceneDsl BubbleChart<X, Y>).() -> Unit)? = null): BubbleChart<X, Y> = BubbleChart(x, y, data).apply { init?.invoke(this) }.add()
...
inline fun ButtonManager.pieChart(data: ObservableList<Data> = mutableObservableListOf(), noinline init: ((@SceneDsl PieChart).() -> Unit)? = null): PieChart = PieChart(data).apply { init?.invoke(this) }.add()
...
inline fun <X, Y> ButtonManager.scatterChart(x: Axis<X>, y: Axis<Y>, data: ObservableList<Series<X, Y>> = mutableObservableListOf(), noinline init: ((@SceneDsl ScatterChart<X, Y>).() -> Unit)? = null): ScatterChart<X, Y> = ScatterChart(x, y, data).apply { init?.invoke(this) }.add()
...
inline fun <X, Y> ButtonManager.stackedAreaChart(x: Axis<X>, y: Axis<Y>, data: ObservableList<Series<X, Y>> = mutableObservableListOf(), noinline init: ((@SceneDsl StackedAreaChart<X, Y>).() -> Unit)? = null): StackedAreaChart<X, Y> = StackedAreaChart(x, y, data).apply { init?.invoke(this) }.add()
...
inline fun <X, Y> ButtonManager.stackedBarChart(x: Axis<X>, y: Axis<Y>, data: ObservableList<Series<X, Y>> = mutableObservableListOf(), noinline init: ((@SceneDsl StackedBarChart<X, Y>).() -> Unit)? = null): StackedBarChart<X, Y> = StackedBarChart(x, y, data).apply { init?.invoke(this) }.add()
//</editor-fold>
