...
inline operator fun <V> WritableValue<in V>.setValue(thisRef: Any?, property: KProperty<*>, value: V?): Unit =
    setValue(value)
...
inline operator fun WritableStringValue.setValue(thisRef: Any?, property: KProperty<*>, value: String?): Unit =
    set(value)
...
inline operator fun WritableBooleanValue.setValue(thisRef: Any?, property: KProperty<*>, value: Boolean): Unit =
    set(value)
...
inline operator fun WritableDoubleValue.setValue(thisRef: Any?, property: KProperty<*>, value: Double): Unit =
    set(value)
...
inline operator fun WritableFloatValue.setValue(thisRef: Any?, property: KProperty<*>, value: Float): Unit = set(value)
...
inline operator fun WritableIntegerValue.setValue(thisRef: Any?, property: KProperty<*>, value: Int): Unit = set(value)
...
inline operator fun WritableLongValue.setValue(thisRef: Any?, property: KProperty<*>, value: Long): Unit = set(value)

/** Delegated property of this read-only [List] value, use with `by` keyword. */
inline operator fun <E> ObservableListValue<E>.getValue(
    thisRef: Any?,
    property: KProperty<*>
): ObservableList<E>? = get()

/** Delegated property of this writable [List] value, use with `by` keyword. */
...
/** Delegated property of this read-only [Set] value, use with `by` keyword. */
inline operator fun <E> ObservableSetValue<E>.getValue(
    thisRef: Any?,
    property: KProperty<*>
): ObservableSet<E>? = get()

/** Delegated property of this writable [Set] value, use with `by` keyword. */
...
/** Delegated property of this read-only [Map] value, use with `by` keyword. */
inline operator fun <K, V> ObservableMapValue<K, V>.getValue(
    thisRef: Any?,
    property: KProperty<*>
): ObservableMap<K, V>? = get()

/** Delegated property of this writable [Map] value, use with `by` keyword. */
