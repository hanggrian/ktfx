...
inline fun <E> emptyListProperty(): ListProperty<E> =
    listPropertyOf(emptyObservableList())

/** Create an empty list modifiable property. */
inline fun <E> listPropertyOf(): ListProperty<E> =
    emptyListProperty()

/** Create a singleton list modifiable property. */
inline fun <E> listPropertyOf(element: E): ListProperty<E> =
    listPropertyOf(observableListOf(element))

/** Create a list modifiable property. */
inline fun <E> listPropertyOf(vararg elements: E): ListProperty<E> =
...
inline fun <E> finalEmptyListProperty(): ReadOnlyListProperty<E> =
    finalListPropertyOf(emptyObservableList())

/** Create an empty list unmodifiable property. */
inline fun <E> finalListPropertyOf(): ReadOnlyListProperty<E> =
    finalEmptyListProperty()

/** Create a singleton list unmodifiable property. */
inline fun <E> finalListPropertyOf(element: E): ReadOnlyListProperty<E> =
    finalListPropertyOf(observableListOf(element))
...
inline fun <E> ObservableList<E>?.toProperty(): ListProperty<E> =
    listPropertyOf(this)

/** Converts this list to final property. */
inline fun <E> ObservableList<E>?.toFinalProperty(): ReadOnlyListProperty<E> =
    finalListPropertyOf(this)
