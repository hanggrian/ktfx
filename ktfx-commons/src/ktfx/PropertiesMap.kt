...
inline fun <K, V> emptyMapProperty(): MapProperty<K, V> =
    mapPropertyOf(emptyObservableMap())

/** Create an empty map modifiable property. */
inline fun <K, V> mapPropertyOf(): MapProperty<K, V> =
    emptyMapProperty()
...
inline fun <K, V> finalEmptyMapProperty(): ReadOnlyMapProperty<K, V> =
    finalMapPropertyOf(emptyObservableMap())

/** Create an empty map unmodifiable property. */
inline fun <K, V> finalMapPropertyOf(): ReadOnlyMapProperty<K, V> =
    finalEmptyMapProperty()
...
inline fun <K, V> ObservableMap<K, V>?.toProperty(): MapProperty<K, V> =
    mapPropertyOf(this)

/** Converts this map to final property. */
inline fun <K, V> ObservableMap<K, V>?.toFinalProperty(): ReadOnlyMapProperty<K, V> =
    finalMapPropertyOf(this)
