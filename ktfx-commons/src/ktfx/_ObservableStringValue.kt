 ...
 * @see String.trim
 */
inline fun ObservableStringValue.trim(): StringBinding = toStringBinding { checkNotNull(it) {
    "String value is null" }.trim() }

/**
 * @see String.trimStart
 */
inline fun ObservableStringValue.trimStart(): StringBinding = toStringBinding { checkNotNull(it) {
    "String value is null" }.trimStart() }

/**
 * @see String.trimEnd
 */
inline fun ObservableStringValue.trimEnd(): StringBinding = toStringBinding { checkNotNull(it) {
    "String value is null" }.trimEnd() }
 ...
 */
inline fun ObservableStringValue.isNotBlank(): BooleanBinding = toBooleanBinding { checkNotNull(it)
    { "String value is null" }.isNotBlank() }
 ...
 */
inline fun ObservableStringValue.substringBefore(delimiter: Char, missingDelimiterValue: String =
    value): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
    }.substringBefore(delimiter, missingDelimiterValue) }

/**
 * @see String.substringBefore
 */
inline fun ObservableStringValue.substringBefore(delimiter: String, missingDelimiterValue: String =
    value): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
    }.substringBefore(delimiter, missingDelimiterValue) }
 ...
 */
inline fun ObservableStringValue.substringAfter(delimiter: Char, missingDelimiterValue: String =
    value): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
 ...
 * @see String.substringAfter
 */
inline fun ObservableStringValue.substringAfter(delimiter: String, missingDelimiterValue: String =
    value): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
    }.substringAfter(delimiter, missingDelimiterValue) }
 ...
 */
inline fun ObservableStringValue.substringBeforeLast(delimiter: Char, missingDelimiterValue: String
    = value): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
 ...
 * @see String.substringBeforeLast
 */
inline fun ObservableStringValue.substringBeforeLast(delimiter: String,
    missingDelimiterValue: String = value): StringBinding = toStringBinding { checkNotNull(it) {
    "String value is null" }.substringBeforeLast(delimiter, missingDelimiterValue) }

/**
 * @see String.substringAfterLast
 */
inline fun ObservableStringValue.substringAfterLast(delimiter: Char, missingDelimiterValue: String =
    value): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
 ...
 * @see String.substringAfterLast
 */
inline fun ObservableStringValue.substringAfterLast(delimiter: String, missingDelimiterValue: String
    = value): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
    }.substringAfterLast(delimiter, missingDelimiterValue) }
...
inline fun ObservableStringValue.replaceRange(range: IntRange, replacement: String): StringBinding =
    toStringBinding { checkNotNull(it) { "String value is null" }.replaceRange(range, replacement) }

/**
 * @see String.removeRange
 */
inline fun ObservableStringValue.removeRange(startIndex: Int, endIndex: Int): StringBinding =
    toStringBinding { checkNotNull(it) { "String value is null" }.removeRange(startIndex, endIndex)
    }
...
inline fun ObservableStringValue.removeSurrounding(prefix: String, suffix: String): StringBinding =
    toStringBinding { checkNotNull(it) { "String value is null" }.removeSurrounding(prefix, suffix)
    }
 ...
 * @see String.replace
 */
inline fun ObservableStringValue.replace(regex: Regex, noinline transform: (MatchResult) ->
    CharSequence): StringBinding = toStringBinding { checkNotNull(it) { "String value is null"
...
inline fun ObservableStringValue.replaceFirst(regex: Regex, replacement: String): StringBinding =
    toStringBinding { checkNotNull(it) { "String value is null" }.replaceFirst(regex, replacement) }
...
inline fun ObservableStringValue.startsWith(char: Char, ignoreCase: Boolean = false): BooleanBinding
    = toBooleanBinding { checkNotNull(it) { "String value is null" }.startsWith(char, ignoreCase) }
...
inline fun ObservableStringValue.contains(other: String, ignoreCase: Boolean = false):
    BooleanBinding = toBooleanBinding { checkNotNull(it) { "String value is null" }.contains(other,
    ignoreCase) }
