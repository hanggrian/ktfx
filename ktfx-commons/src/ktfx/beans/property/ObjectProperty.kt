...
inline fun <T> T?.asReadOnlyProperty(): ReadOnlyObjectProperty<T> = ReadOnlyObjectWrapper(this)

/** Wrap this object in modifiable property. */
inline fun <T> T?.asProperty(): ObjectProperty<T> = SimpleObjectProperty(this)
