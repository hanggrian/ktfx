...
fun ObservableStringValue.isBlank(): BooleanBinding = KtFXInternals.newBooleanBinding(this) {
    get().isNullOrBlank()
}

fun ObservableStringValue.isNotBlank(): BooleanBinding = KtFXInternals.newBooleanBinding(this) {
    !get().isNullOrBlank()
}