 ...
 */
inline fun ObservableStringValue.trimStart(crossinline predicate: (Char) -> Boolean):
    StringBinding {
 ...
 * @see String.trim
 */
inline fun ObservableStringValue.trim(vararg chars: Char): StringBinding {
 ...
 * @see String.trimStart
 */
inline fun ObservableStringValue.trimStart(vararg chars: Char): StringBinding {
 ...
 * @see String.trimEnd
 */
inline fun ObservableStringValue.trimEnd(vararg chars: Char): StringBinding {
 ...
 */
inline fun ObservableStringValue.substring(range: IntRange): StringBinding {
 ...
 * @see String.removeRange
 */
inline fun ObservableStringValue.removeRange(range: IntRange): StringBinding {
 ...
 */
inline fun ObservableStringValue.removePrefix(prefix: String): StringBinding {
 ...
 */
inline fun ObservableStringValue.removeSuffix(suffix: String): StringBinding {
 ...
 * @see String.matches
 */
inline fun ObservableStringValue.matches(regex: Regex): BooleanBinding {
 ...
 */
inline fun ObservableStringValue.startsWith(char: Char, ignoreCase: Boolean = false):
    BooleanBinding {
 ...
 * @see String.contains
 */
inline fun ObservableStringValue.contains(regex: Regex): BooleanBinding {
