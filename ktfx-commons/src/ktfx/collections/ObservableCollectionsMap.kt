...
inline val <K, V> ObservableMap<K, V>.sizeBinding: IntegerBinding
    get() = Bindings.size(this)

inline val <K, V> ObservableMap<K, V>.isEmptyBinding: BooleanBinding
    get() = Bindings.isEmpty(this)

inline val <K, V> ObservableMap<K, V>.isNotEmptyBinding: BooleanBinding
