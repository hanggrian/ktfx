 ...
 */
fun BufferedImage.toFxImage(wimg: WritableImage? = null): WritableImage = SwingFXUtils.toFXImage(this, wimg)

/**
 * Snapshots the specified JavaFX [Image] object and stores a copy of its pixels into a [BufferedImage] object,
 * creating a new object if needed.
 */
fun Image.toSwingImage(bimg: BufferedImage? = null): BufferedImage = SwingFXUtils.fromFXImage(this, bimg)
