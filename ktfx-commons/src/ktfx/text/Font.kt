...
val Number.pt: Font get() = toDouble().pt
...
fun fontOf(family: String? = null, weight: FontWeight? = null, size: Number): Font =
...
fun italicFontOf(family: String? = null, weight: FontWeight? = null, size: Number): Font =
...
fun loadFont(url: String, size: Number): Font = loadFont(url, size.toDouble())
...
fun loadFont(stream: InputStream, size: Number): Font = loadFont(stream, size.toDouble())
