...
public fun insetsOf(top: Long = 0L, right: Long = 0L, bottom: Long = 0L, left: Long = 0L): Insets =
    insetsOf(top.toDouble(), right.toDouble(), bottom.toDouble(), left.toDouble())

/** Create an inset where [Double] number will be applied to each side. */
public inline fun insetsOf(
    top: Double = 0.0,
    right: Double = 0.0,
    bottom: Double = 0.0,
    left: Double = 0.0,
