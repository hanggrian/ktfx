...
abstract class CollectionTest<T : MutableCollection<String>> {
    ...
    fun creating() {
        ...
        assertThat(mutableFilled)
            .containsExactly(*FILL_VALUES, ADD_VALUE)
    }
