...
inline fun ChildManager.box(width: Double = DEFAULT_SIZE, height: Double = DEFAULT_SIZE, depth: Double = DEFAULT_SIZE, noinline init: ((@LayoutDsl Box).() -> Unit)? = null): Box = ktfx.layouts.box(width, height, depth, init).add()
inline fun ItemManager.box(width: Double = DEFAULT_SIZE, height: Double = DEFAULT_SIZE, depth: Double = DEFAULT_SIZE, noinline init: ((@LayoutDsl Box).() -> Unit)? = null): Box = ktfx.layouts.box(width, height, depth, init).add()
inline fun ButtonManager.box(width: Double = DEFAULT_SIZE, height: Double = DEFAULT_SIZE, depth: Double = DEFAULT_SIZE, noinline init: ((@LayoutDsl Box).() -> Unit)? = null): Box = ktfx.layouts.box(width, height, depth, init).add()
...
inline fun ChildManager.polygon(vararg points: Double, noinline init: ((@LayoutDsl Polygon).() -> Unit)? = null): Polygon = ktfx.layouts.polygon(*points, init = init).add()
inline fun ItemManager.polygon(vararg points: Double, noinline init: ((@LayoutDsl Polygon).() -> Unit)? = null): Polygon = ktfx.layouts.polygon(*points, init = init).add()
inline fun ButtonManager.polygon(vararg points: Double, noinline init: ((@LayoutDsl Polygon).() -> Unit)? = null): Polygon = ktfx.layouts.polygon(*points, init = init).add()
...
inline fun ChildManager.rectangle(x: Double = 0.0, y: Double = 0.0, width: Double = 0.0, height: Double = 0.0, noinline init: ((@LayoutDsl Rectangle).() -> Unit)? = null): Rectangle = ktfx.layouts.rectangle(x, y, width, height, init).add()
inline fun ItemManager.rectangle(x: Double = 0.0, y: Double = 0.0, width: Double = 0.0, height: Double = 0.0, noinline init: ((@LayoutDsl Rectangle).() -> Unit)? = null): Rectangle = ktfx.layouts.rectangle(x, y, width, height, init).add()
inline fun ButtonManager.rectangle(x: Double = 0.0, y: Double = 0.0, width: Double = 0.0, height: Double = 0.0, noinline init: ((@LayoutDsl Rectangle).() -> Unit)? = null): Rectangle = ktfx.layouts.rectangle(x, y, width, height, init).add()
