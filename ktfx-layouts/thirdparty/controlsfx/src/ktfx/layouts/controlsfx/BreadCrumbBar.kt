...
): BreadCrumbBar<T> = ktfx.layouts.controlsfx.breadCrumbBar(selectedCrumb, init)()
...
inline fun <T> LayoutManager<Node>.styledBreadCrumbBar(
    ...
    selectedCrumb: TreeItem<T>? = null,
    noinline init: ((@LayoutDsl BreadCrumbBar<T>).() -> Unit)? = null
): BreadCrumbBar<T> = ktfx.layouts.controlsfx.styledBreadCrumbBar(styleClass, selectedCrumb, init)()