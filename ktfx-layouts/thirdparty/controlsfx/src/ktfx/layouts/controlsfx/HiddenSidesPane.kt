...
): HiddenSidesPane = ktfx.layouts.controlsfx.hiddenSidesPane(content, top, right, bottom, left, init)()
...
inline fun LayoutManager<Node>.styledHiddenSidesPane(
    ...
    ktfx.layouts.controlsfx.styledHiddenSidesPane(styleClass, content, top, right, bottom, left, init)()