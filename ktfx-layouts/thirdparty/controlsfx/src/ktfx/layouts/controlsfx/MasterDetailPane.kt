...
): MasterDetailPane = ktfx.layouts.controlsfx.masterDetailPane(side, showDetail, init = init)()
...
inline fun LayoutManager<Node>.styledMasterDetailPane(
    ...
    showDetail: Boolean = true,
    noinline init: ((@LayoutDsl _MasterDetailPane).() -> Unit)? = null
): MasterDetailPane = ktfx.layouts.controlsfx.styledMasterDetailPane(styleClass, side, showDetail, init = init)()