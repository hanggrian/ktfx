...
): RangeSlider = ktfx.layouts.controlsfx.rangeSlider(min, max, lowValue, highValue, init)()
...
inline fun LayoutManager<Node>.styledRangeSlider(
    ...
    highValue: Double = 0.75,
    noinline init: ((@LayoutDsl RangeSlider).() -> Unit)? = null
): RangeSlider = ktfx.layouts.controlsfx.styledRangeSlider(styleClass, min, max, lowValue, highValue, init)()