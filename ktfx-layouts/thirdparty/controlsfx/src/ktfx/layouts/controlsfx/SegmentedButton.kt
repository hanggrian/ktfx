...
): SegmentedButton = ktfx.layouts.controlsfx.segmentedButton(*buttons, init = init)()
...
inline fun LayoutManager<Node>.styledSegmentedButton(
    ...
    vararg buttons: ToggleButton,
    noinline init: ((@LayoutDsl _SegmentedButton).() -> Unit)? = null
): SegmentedButton = ktfx.layouts.controlsfx.styledSegmentedButton(styleClass, *buttons, init = init)()