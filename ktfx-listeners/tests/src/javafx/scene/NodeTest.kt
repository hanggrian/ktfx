...
class NodeTest : BaseNodeTest() {
    ...
    override fun Node.callOnRotateStarted(action: (RotateEvent) -> Unit) = onRotateStarted(action)
    override fun Node.callOnRotate(action: (RotateEvent) -> Unit) = onRotate(action)
    override fun Node.callOnRotateFinished(action: (RotateEvent) -> Unit) = onRotateFinished(action)
