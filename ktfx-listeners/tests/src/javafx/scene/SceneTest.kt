...
class SceneTest : BaseSceneTest() {
    ...
    override fun Scene.callOnRotationStarted(action: (RotateEvent) -> Unit) = onRotationStarted(action)
    override fun Scene.callOnRotate(action: (RotateEvent) -> Unit) = onRotate(action)
    override fun Scene.callOnRotationFinished(action: (RotateEvent) -> Unit) = onRotationFinished(action)
