...
): Arc = javafxx.layouts.arc(centerX, centerY, radiusX, radiusY, startAngle, length, init)()
...
inline fun LayoutManager<Node>.styledArc(
    ...
    length: Double = 0.0,
    noinline init: ((@LayoutDsl Arc).() -> Unit)? = null
): Arc = javafxx.layouts.styledArc(styleClass, centerX, centerY, radiusX, radiusY, startAngle, length, init)()