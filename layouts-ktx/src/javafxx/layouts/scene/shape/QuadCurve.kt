...
): QuadCurve = javafxx.layouts.quadCurve(startX, startY, controlX, controlY, endX, endY, init)()
...
inline fun LayoutManager<Node>.styledQuadCurve(
    ...
    endY: Double = 0.0,
    noinline init: ((@LayoutDsl QuadCurve).() -> Unit)? = null
): QuadCurve = javafxx.layouts.styledQuadCurve(styleClass, startX, startY, controlX, controlY, endX, endY, init)()