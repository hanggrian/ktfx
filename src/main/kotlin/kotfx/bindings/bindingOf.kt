...
inline fun booleanBindingOf(vararg dependencies: Observable, noinline func: () -> Boolean): BooleanBinding = Bindings.createBooleanBinding(Callable { func() }, *dependencies)

/** Helper function to create a custom [DoubleBinding]. */
inline fun doubleBindingOf(vararg dependencies: Observable, noinline func: () -> Double): DoubleBinding = Bindings.createDoubleBinding(Callable { func() }, *dependencies)
