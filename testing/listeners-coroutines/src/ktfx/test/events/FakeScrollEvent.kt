 ...
 * @receiver source of this fake event.
 */
fun Any.fakeScrollEventOf(eventType: EventType<ScrollEvent>) = ScrollEvent(
    ...
    0.0, 0.0,
    0.0, 0.0,
    ScrollEvent.HorizontalTextScrollUnits.CHARACTERS, 0.0,
    ScrollEvent.VerticalTextScrollUnits.LINES, 0.0,
    0, FakePickResult
)