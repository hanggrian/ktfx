 ...
 */
public inline fun NodeContainer.customPasswordField(): CustomPasswordField = customPasswordField() {
        }
 ...
 */
public inline fun styledCustomPasswordField(vararg styleClass: String, id: String? = null):
 ...
 */
public inline fun NodeContainer.styledCustomPasswordField(vararg styleClass: String, id: String? =
        null): CustomPasswordField = styledCustomPasswordField(styleClass = styleClass, id = id) { }
